...
Route::post('/skip-succss', [TabbyPaymentController::class, 'successSkip'])->name('skip.success')->middleware('sanctum');
Route::post('/skip-cancel', [TabbyPaymentController::class, 'cancelSkip'])->name('skip.cancel')->middleware('sanctum');
