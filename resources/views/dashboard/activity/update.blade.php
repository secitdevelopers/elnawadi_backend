...
@section('content')
    ...
    @endif
    <!-- row -->
    <form action="{{ route('activities.update') }}" method="post" enctype="multipart/form-data">
        {{ method_field('post') }}
        {{ csrf_field() }}
        <div class="row">
                ...
                <div class="card">
                        ...
                        <div class="row row-sm">
                            <div class="col-lg">
                                ...
                                <input class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}"
                                    placeholder="اسم النشاط" type="text" name="name_ar" value="{{ $activity->name_ar }}"
                                    required>
                            </div>
                            ...
                            <div class="col-lg">
                                ...
                                <input class="form-control" placeholder="العنوان"type="text" name="adress"
                                    value="{{ $activity->adress }}" required>
                            </div>

                            <div class="col-lg">
                                <p class="mg-b-10">مدة النشاط</p>
                                <input class="form-control" placeholder="قم بإدخال المدة"type="text"
                                    name="activity_duration" value="{{ $activity->activity_duration }}" required>
                            </div>
                            {{-- @php
                    ...
                    <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control" id="datetimepicker2" type="text"
                                                name="start_data" value="{{ $activity->start_data }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control" id="datetimepicker1" type="text"
                                                name="end_data" value="{{ $activity->end_data }}">
                                        </div>
                                    </div>
                                ...
                                <textarea id="textarea" name="description_ar" value="{{ $activity->description_ar }}" rows="15">{{ $activity->description_ar }}</textarea>
                            </div>
                        </div>
                    </div>


                    <input type="text" value="{{ $activity->id }}" name="id" hidden>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-sm-12 col-md-4">
                                                ...
                                                <input type="file" class="dropify"
                                                    data-default-file="{{ URL::asset($activity->image) }}"
                    ...
                    {{-- <div class="row mb-4">
                        <div class="col-sm-12 col-md-4">
                            ...
                            <input type="file" class="dropify" data-default-file="{{ URL::asset($product->image) }}"
                                data-height="200" name="image" enctype="multipart/form-data" />
                        </div>
