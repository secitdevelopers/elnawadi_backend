...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">ادارة الاشتركات /</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">
                </span>
            </div>
        </div>
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">اسم العميل المشترك</th>
                                    <th class="wd-18p border-bottom-0">نوع الاشتراك</th>
                                    <th class="wd-15p border-bottom-0">تاريخ الاشتراك</th>
                                    <th class="wd-15p border-bottom-0">اسم النشاط</th>
                                    <th class="wd-15p border-bottom-0">سعر الاشتراك</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($subscriptions as $subscrip)
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td>{{ $subscrip->name }}</td>
                                        <td>{{ $subscrip->type_scrip }}</td>
                                        <td>{{ $subscrip->created_at->format('d/m/Y') }}</td>
                                        <td>{{ $subscrip->activity->name_ar }}</td>
                                        <td>{{ $subscrip->subscription_amount }}</td>
                                        <td>
                                            <div class="d-flex">
                                                @can('حذف منتج')
                                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                        data-id="{{ $subscrip->id }}" data-name="{{ $i }}"
