                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">سوق المنتج</th>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown">
                                                <button aria-expanded="false" aria-haspopup="true"
                                                    ...
                                                    type="button">سوق المنتج<i class="fas fa-caret-down ml-1"></i></button>
                                                <div class="dropdown-menu tx-13">
                                                    <h6
                                                        class="dropdown-header tx-uppercase tx-11 tx-bold tx-inverse tx-spacing-1">
                                                        اختار اللغه </h6>
                                                    <form id="language-form"
                                                        action="{{ route('products.affiliateProduct') }}" method="GET">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{ $product->id }}">
                                                        <button class="dropdown-item" type="submit" name="locale"
                                                            value="ar">اللغة العربية</button>
                                                        <button class="dropdown-item" type="submit" name="locale"
                                                            value="en">اللغة الإنجليزية</button>
                                                    </form>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                @if ($product->status == true)
                                                    ...
                                                    @can('حذف منتج')
                                                        <a class="modal-effect btn btn-sm btn-danger"
                                                            ...
                                                            data-name="{{ $product->name_ar }}" data-toggle="modal"
                                                ...
                                                @else
                                                    <div class="container">
                                                        ...
                                                        <p><span class="fancy">بانتظار الموافقة على المنتج</span></p>
